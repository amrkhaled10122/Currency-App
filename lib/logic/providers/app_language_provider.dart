...
class AppLanguageProvider extends ChangeNotifier {
  ...
  Future<void> fetchLocale() async {
    await _preferencesService.getLanguageCode().then((value) {
      Fimber.d('Current Localization Language ✝️ ${_appLocale.toString().toUpperCase()}');
      if (value == null) {
  ...
  Future<void> changeLanguage(Locale _locale) async {
    ...
    _appLocale = _locale;
    Fimber.d('Localization Language Has Been Changed To 🥇 ${_appLocale.toString().toUpperCase()}');
