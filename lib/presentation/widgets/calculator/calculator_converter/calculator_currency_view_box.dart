            ...
            return AnimatedSwitcher(
                ...
                child: RichText(
                  ...
                  text: TextSpan(children: <TextSpan>[
                    TextSpan(
                        text: '${(typedValueSnapshot.data ?? 0).makeFormattedWithSpace} ',
                        style: AppStyles.mainHeadlineColor14spw700NotoSansLineHeight),
                    TextSpan(
                        text: '${currencyBloc.fromConversionValue.code} = ',
                        style: AppStyles.mainHeadlineColor14spw700NotoSansLineHeight),
                    TextSpan(
                      text: '${(conversionValueSnapshot.data ?? 0).makeFormattedWithSpace} ',
                      style: AppStyles.mainHeadlineColor14spw700NotoSansLineHeight,
                    ),
                    TextSpan(
