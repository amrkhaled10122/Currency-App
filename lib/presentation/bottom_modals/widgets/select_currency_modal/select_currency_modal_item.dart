...
class SelectCurrencyModalItem extends StatelessWidget {
  ...
  const SelectCurrencyModalItem(
      {Key? key, required this.index, required this.selectCurrencyTap, required this.currency})
      : super(key: key);
        ...
        child: Padding(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
                color: currency.isSelected ? AppPalette.mainBlueColor : AppPalette.whiteColor,
                    ...
                    children: <Widget>[
                      ...
                      Flexible(
                        child: Text(
                          ...
                          style: TextStyle(
                              color: currency.isSelected ? AppPalette.whiteColor : AppPalette.mainHeadlineBlackColor,
